    ...
    <div className="mx-auto flex min-h-dvh max-w-lg flex-col items-center justify-center bg-[#f7f9fa] px-5 py-12">
      ...
      <div className="mt-8 w-full space-y-3">
        <button
          ...
          className="ch-btn-primary flex w-full items-center justify-center gap-2 py-4 text-[16px] font-bold"
        >
          방 사진 올리기
        ...
        <button
          ...
          className="w-full py-3 text-[14px] font-semibold text-[#828c94]"
        >
          나중에 하기
        </button>
      </div>
